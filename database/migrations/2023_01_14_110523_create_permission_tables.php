...
class CreatePermissionTables extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::create(
            ...
            $table->foreign(PermissionRegistrar::$pivotPermission)->references('id') // permission id
            ->on($tableNames['permissions'])->onDelete('cascade');
            if ($teams)
            {
        ...
        Schema::create(
            ...
            $table->foreign(PermissionRegistrar::$pivotRole)->references('id') // role id
            ->on($tableNames['roles'])->onDelete('cascade');
            if ($teams)
            {
                $table->unsignedBigInteger($columnNames['team_foreign_key']);
